...
class JTM_plugin {
    ...
    */
    ...
    public function jtm_plugin_admin_scripts() {
        ...
        wp_enqueue_style(
            'jtm-plugin-admin-css',
            JTM_PLUGIN_DIR_URL . 'admin/css/admin.css',
            array(),
            JTM_PLUGIN_VERSION
        );
        ...
        wp_enqueue_script(
            'jtm-plugin-admin-js',
            JTM_PLUGIN_DIR_URL . 'admin/js/admin.js',
            array('jquery'),
            JTM_PLUGIN_VERSION,
            true
        );
        ...
        wp_enqueue_script(
            'jtm-plugin-ajax-js',
            JTM_PLUGIN_DIR_URL . 'admin/js/ajax.js',
            array('jquery'),
            JTM_PLUGIN_VERSION,
            true
        );
    ...
    */
    ...
    public function jtm_plugin_public_scripts() {

        wp_enqueue_style(
            'jtm-plugin-public-css',
            JTM_PLUGIN_DIR_URL . 'public/css/public.css',
            array(),
            JTM_PLUGIN_VERSION
        );

        wp_enqueue_script(
            'jtm-plugin-public-js',
            JTM_PLUGIN_DIR_URL . 'public/js/public.js',
            array('jquery'),
            JTM_PLUGIN_VERSION,
            true
        );
